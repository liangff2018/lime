      ...
      >
        <a-row justify="center">
          ...
          <template v-if="advanced">
            ...
            <a-col :span="8">
              <a-form-model-item label="培训内容要求">
...
import { findPage, deleteById, update } from '@/api/hr/trainRequire'
import TrainRequireForm from './TrainRequireForm'
...
export default {
  ...
  methods: {
    ...
    showFormClick (operateType, id) {
      this.$router.push({ name: 'trainRequireForm', params: { id: id, operateType: operateType } })
    },
    deleteClick (id) {
