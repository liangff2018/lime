...
import { findPage, deleteById, updateBillState } from '@/api/hr/recruitRequire'
import RecruitRequireForm from './RecruitRequireForm'
...
const columns = [
  ...
  { title: '操作', width: '198px', scopedSlots: { customRender: 'action' } }
]
...
export default {
  ...
  methods: {
    ...
    showFormClick (operateType, id) {
      this.$router.push({ name: 'recruitRequireForm', params: { id: id, operateType: operateType } })
    },
    deleteClick (id) {
