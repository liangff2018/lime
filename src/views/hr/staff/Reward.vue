      ...
      >
        <a-row justify="center">
          ...
          <template v-if="advanced">
            ...
            <a-col :span="8">
              <a-form-model-item label="奖惩类型">
                <a-select v-model="queryParam.rewardType">
...
import { findPage, deleteById, update } from '@/api/hr/reward'
...
const columns = [
  ...
  { title: '奖惩类型', dataIndex: 'rewardType' },
  { title: '金额', dataIndex: 'amount' },
  { title: '奖惩日期', dataIndex: 'startDate', customRender: val => val ? moment(val).format('YYYY-MM-DD') : '' },
...
export default {
  ...
  methods: {
    ...
    showFormClick (operateType, id) {
      this.$router.push({ name: 'rewardForm', params: { id: id, operateType: operateType } })
    },
    deleteClick (id) {
