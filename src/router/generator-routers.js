...
const constantRouterComponents = {
  ...
  'RecruitRequire': () => import('@/views/hr/staff/RecruitRequire'),
  'RecruitRequireForm': () => import('@/views/hr/staff/RecruitRequireForm'),
  'RecruitPlan': () => import('@/views/hr/staff/RecruitPlan'),
  'RecruitPlanForm': () => import('@/views/hr/staff/RecruitPlanForm'),
  'Interview': () => import('@/views/hr/staff/Interview'),
  'InterviewForm': () => import('@/views/hr/staff/InterviewForm'),
  'TrainRequire': () => import('@/views/hr/staff/TrainRequire'),
  'TrainRequireForm': () => import('@/views/hr/staff/TrainRequireForm'),
  'TrainPlan': () => import('@/views/hr/staff/TrainPlan'),
...
export const generatorDynamicRouter = (token) => {
  return new Promise((resolve, reject) => {
    loginService.getCurrentUserNav(token).then(res => {
      ...
      // lcy 注释上面的代码，修改根级PID为字符串.开始
      // 白菜单 合并 后台返回的菜单
      const temp = result.concat(whiteNav)
      listToTree(temp, childrenNav, '0')
      // lcy 注释上面的代码，修改根级PID为字符串.结束
